// =========================================================
// SERVICE WORKER - ZIPMANAGER V2.1.5 (AIR-GAP)
// =========================================================

const CACHE_NAME = 'zipmanager-v2.1.6';
...
self.addEventListener('install', (event) => {
    event.waitUntil(
        caches.open(CACHE_NAME)
            .then((cache) => {
                console.log('[Service Worker] Mise en cache des ressources v2.1.5');
...
// Phase 3 : Interception des requêtes (Air-Gap local)
